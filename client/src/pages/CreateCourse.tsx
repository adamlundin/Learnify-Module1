            ...
            <Form {...formItemLayout} form={form} name="course" onFinish={onSubmit}>
                ...
                <Form.Item name="description" label="Course Description"
                    rules={[
                        ...
                        <Input.TextArea onChange={handleChange} name="description" value={description}/>
                </Form.Item>
                <Form.Item name="price" label="Course Price"
                    rules={[
                        ...
                        <InputNumber name="price" placeholder="Course Price" value={price} onChange={(value) => setValues({
                            ...values, price: value
                        })}/>
                </Form.Item>
                <Form.Item name="category" label="Course Category"
                    rules={[
                        {
                            required: true,
                ...
                <Form.Item name="level" label="Course Level"
                    rules={[
                        {
                            required: true,
                            message: "Please choose a level of the course",
                        },
                    ]}>
                        <Select 
                            value={level} 
                ...
                <Form.Item name="language" label="Course Language"
                    rules={[
                        {
                            required: true,
                            message: "Please choose a language of the course",
                        },
                    ]}>
                        <Select 
                            value={language} 
